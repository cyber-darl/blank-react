    ...
    <div className="doctor-card-container">
      <div className="doctor-card-details-container">
        ...
        <div className="doctor-card-details">
          <div className="doctor-card-detail-name">Dr. Jiao Xing</div>
          <div className="doctor-card-detail-speciality">Dentist</div>
          <div className="doctor-card-detail-experience">5 years experience</div>
          ...
          {(close) => (
            <div className="doctorbg" style={{ height: '100vh', overflow: 'scroll' }}>
              <div>
                ...
                <div className="doctor-card-details">
                  <div className="doctor-card-detail-name">Dr Xiao Jing</div>
                  <div className="doctor-card-detail-speciality">dentist</div>
                  <div className="doctor-card-detail-experience">5 years experience</div>
                  <div className="doctor-card-detail-consultationfees">Ratings: {ratings}</div>
                </div>
